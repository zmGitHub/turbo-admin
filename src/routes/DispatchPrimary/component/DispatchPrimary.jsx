...
import DispatchPrimaryForm from './DispatchPrimaryForm';

class DispatchPrimary extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Portlet title="一次发运费管理" subTitle="自定义查询" icon="list" color="font-green-sharp">
        <DispatchPrimaryForm onSubmit={this.query} />
...
function mapStateToProps(state) {
  return { items: state.basicReducer.dispatchPrimary };
}

DispatchPrimary.propTypes = {
  dispatch: PropTypes.func.isRequired,
  items: PropTypes.object
};

export default connect(mapStateToProps)(DispatchPrimary);
