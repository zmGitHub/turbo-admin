...
class DispatchCrossingForm extends Component {
  render() {
    const {
      fields: { time, spareDescribe, sendBranchName },
      resetForm,
      handleSubmit
    } = this.props;
    return (
...
DispatchCrossingForm.propTypes = {
...
export default reduxForm({
  form: 'DispatchCrossingForm',
  fields: ['time', 'spareDescribe', 'sendBranchName']
})(DispatchCrossingForm);
